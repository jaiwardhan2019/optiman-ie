...
<head>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                      ...
                      <div class="card mb-3">
                        ...
                        <div class="card-body">
                          ...
                          <form class="row g-3 needs-validation" novalidate action="validate-admin" method="post" onSubmit="return validateAdmin()";>
                            ...
                            <div class="col-12">
                              <button class="btn btn-primary w-100" type="submit" id="loginButton" name="loginButton" onSubmit="validateAdmin(endPointName)" > Login </button>
                            </div>
                            <div class="col-12">
 ...
 <script>
         ...
         function validateAdmin(endPointName){
            //--- Change button label to In progress
            //const loginReg = document.getElementById("loginButton");
            //loginReg.disabled = true;
            //loginReg.innerHTML = '<i class="fa fa-spinner fa-pulse fa-lg"> </i> Login In progress...';
            document.submit();
         }
